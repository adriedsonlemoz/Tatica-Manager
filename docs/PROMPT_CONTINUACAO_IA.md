...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.97 com versionCode > 98.
...
1. Validar a 0.1.1.96 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
