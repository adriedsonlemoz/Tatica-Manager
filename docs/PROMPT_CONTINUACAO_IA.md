...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.105 com versionCode > 105.
...
1. Validar a 0.1.1.104 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
