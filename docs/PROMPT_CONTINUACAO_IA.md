...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.101 com versionCode > 101.

Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.95 com versionCode > 96.
...
1. Validar a 0.1.1.97 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
