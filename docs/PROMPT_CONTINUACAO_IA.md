...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.81 com versionCode > 82.
...
1. Validar a 0.1.1.80 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
