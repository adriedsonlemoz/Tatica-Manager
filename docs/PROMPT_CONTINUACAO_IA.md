...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.94 com versionCode > 95.
...
1. Validar a 0.1.1.93 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
