...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.92 com versionCode > 93.
...
1. Validar a 0.1.1.91 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
