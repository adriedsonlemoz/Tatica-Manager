...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.86 com versionCode > 87.
...
1. Validar a 0.1.1.85 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
