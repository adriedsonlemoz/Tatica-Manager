...
Antes de qualquer nova entrega, incremente a versão. Partindo deste handoff, a próxima normalmente será 0.1.1.79 com versionCode > 80.
...
1. Validar a 0.1.1.78 no GitHub Actions, incluindo `flutter analyze`, testes e build release.
