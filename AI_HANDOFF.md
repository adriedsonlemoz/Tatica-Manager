...
- **Release deste handoff:** `0.1.1.100`
...
release/versionName: 0.1.1.100
versionCode:         101
pubspec:             0.1.1+101

A próxima alteração/entrega normalmente deve virar `0.1.1.101` e usar um `versionCode` maior que 101.
