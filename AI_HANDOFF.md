...
- **Release deste handoff:** `0.1.1.98`
...
release/versionName: 0.1.1.98
versionCode:         100
pubspec:             0.1.1+100

A próxima alteração/entrega normalmente deve virar `0.1.1.99` e usar um `versionCode` maior que 100.
