...
- **Release deste handoff:** `0.1.1.72`
...
release/versionName: 0.1.1.72
versionCode:         74
pubspec:             0.1.1+74

A próxima alteração/entrega normalmente deve virar `0.1.1.73` e usar um `versionCode` maior que 74.
