...
- **Release deste handoff:** `0.1.1.126`
...
```text
release/versionName: 0.1.1.126
versionCode:         127
pubspec:             0.1.1+127
```

A próxima alteração/entrega normalmente deve virar `0.1.1.127` e usar um `versionCode` maior que 127.
