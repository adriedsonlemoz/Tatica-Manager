...
- **Release deste handoff:** `0.1.1.67`
...
release/versionName: 0.1.1.67
versionCode:         69
pubspec:             0.1.1+69

A próxima alteração/entrega normalmente deve virar `0.1.1.68` e usar um `versionCode` maior que 69.
